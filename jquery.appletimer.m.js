(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		format: function() {
			...
			t.monthsLabel = (mm == 1 && mmL !== null && sL == true) ? mmL : s.monthsLabel;
		...
		output: function() {
			...
			t.writeLabelToDom(s.monthsLabelWrapper, t.monthsLabel);
			...
			t.writeDigitsToDom(s.monthsWrapper, t.months, 'at-months-digit');
